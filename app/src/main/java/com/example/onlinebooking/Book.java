 ...
 */
 ...
 public class Book {
     String B_name,A_name,B_page,B_words,B_price,B_edition,B_code,link;

     public Book(String a,String b,String c,String d,String e,String f,String g,String link){
          this.B_name=a;
          this.A_name=b;
          this.B_page=c;
          this.B_words=d;
