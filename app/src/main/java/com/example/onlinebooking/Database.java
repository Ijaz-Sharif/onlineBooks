 ...
 */
 ...
 public class Database extends SQLiteOpenHelper {
    ...
    public static final String Col_8 = "B_code";
    public static final String Col_7 = "B_link";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(" create table " + TName + "(" + Col_1 + " TEXT," + Col_2 + " TEXT," + Col_3 + " TEXT," + Col_4 + " TEXT,"
                + Col_5 + " TEXT," + Col_6 + " TEXT," + Col_7 + " TEXT," + Col_8 + " TEXT PRIMARY KEY)");
    }
...
// function to add data into database
    public void Add(Book book){
        ...
        cv.put(Col_7,book.getLink());
        cv.put(Col_8,book.getB_code());
...
// function to get data from database
    public ArrayList<Book> getData(){
        ...
        while (!cursor.isAfterLast()){
            ...
            Book ca=new Book(a,b,c,d,e,f,g,link);
            dataList.add(ca);
            cursor.moveToNext();
        }
