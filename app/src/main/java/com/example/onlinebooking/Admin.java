...
public class Admin extends AppCompatActivity {
    ...
    private final static String default_notification_channel_id = "default" ;
          EditText B_name,A_name,B_page,B_words,B_price,B_edition,B_code,book_link;
          Button button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book_link=findViewById(R.id.book_link);
        B_edition=findViewById(R.id.bedition);
        B_code=findViewById(R.id.code);
        button=findViewById(R.id.sa);
        B_name.setTextColor(getResources().getColor(R.color.black));
            ...
            public void onClick(View v) {
             if(B_name.getText().toString().equals("")||A_name.getText().toString().equals("")||
                 ...
                 Book book=new Book(B_name.getText().toString(),A_name.getText().toString(),
                         ...
                         B_edition.getText().toString(),B_code.getText().toString(),book_link.getText().toString());
